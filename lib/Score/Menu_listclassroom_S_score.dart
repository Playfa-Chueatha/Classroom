...
class MenuListclassroomSScore extends StatefulWidget {
  final String username;
  final String thfname;
  final String thlname;

  const MenuListclassroomSScore({super.key, required this.username, required this.thfname, required this.thlname});

  @override
  State<MenuListclassroomSScore> createState() => _List_classroomState();
}

class _List_classroomState extends State<MenuListclassroomSScore> {
